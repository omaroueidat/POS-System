...
namespace Entities.Migrations
{
    ...
    [Migration("20240829063417_Altering-Tables-Ading-CreatedAt-UpdatedAt")]
    partial class AlteringTablesAdingCreatedAtUpdatedAt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Entities.Domain.Application.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            AdminId = new Guid("57c34bc4-a4d5-4124-8f95-db13978fbeac"),
                            AppUserId = new Guid("57c34bc4-a4d5-4124-8f95-db13978fbeaa")
                        });
                });

            modelBuilder.Entity("Entities.Domain.Application.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedEmail = "TAWFEER@GMAIL.COM",
                            NormalizedUserName = "TAWFEER",
                            PhoneNumberConfirmed = false,
                            Role = "SuperMarket",
                            TwoFactorEnabled = false,
                            UserName = "tawfeer"
            ...
            modelBuilder.Entity("Entities.Domain.Product.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CategoryId = new Guid("63e2c242-e7c2-4ac1-8545-8c635c2cb97b"),
                            CategoryName = "Food"
                        },
                        new
                        {
                            CategoryId = new Guid("63e2c242-e7c2-4ac1-8545-8c635c2cb97c"),
            ...
            modelBuilder.Entity("Entities.Models.EmployeeModels.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "1 Main St",
                            AppUserId = new Guid("57c34bc4-a4d5-4124-8f95-db13978fbeac"),
            ...
            modelBuilder.Entity("Entities.Models.SuperMarketModels.SuperMarket", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            SuperMarketId = new Guid("5f2cfd7a-f135-4dad-9ebd-97014f203791"),
                            AppUserId = new Guid("57c34bc4-a4d5-4124-8f95-db13978fbeab"),
                            PhoneNumber = 0,
                            SupermarketName = "Tawfeer"
                        });
                });
            ...
            modelBuilder.Entity("Entities.Domain.Application.Admin", b =>
                {
                    b.HasOne("Entities.Domain.Application.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("Entities.Domain.Application.Admin", "AppUserId")
            ...
            modelBuilder.Entity("Entities.Models.EmployeeModels.Employee", b =>
                {
                    b.HasOne("Entities.Domain.Application.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("Entities.Models.EmployeeModels.Employee", "AppUserId")
            ...
            modelBuilder.Entity("Entities.Models.SuperMarketModels.SuperMarket", b =>
                {
                    b.HasOne("Entities.Domain.Application.AppUser", "AppUser")
                        .WithOne()
                        .HasForeignKey("Entities.Models.SuperMarketModels.SuperMarket", "AppUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Entities.Domain.Application.AppUser", null)
                        .WithMany()
